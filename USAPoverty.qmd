...
#plot_colors <- c("#1CADE4", "#42BA97", "#2683C6", "#3E8853", "#27CED7", "#62A39F")

# Define colors for PovertyStatus
plot_colors <- c("#27CED7", "#3E8853")  # Adjust for clear contrast
...
-   **First Graph (Marital Status)**: The graph shows clusters of individuals grouped by their marital status, highlighting connections based on shared marital categories like single, married, or widowed.

    ![](images/sim3-01.jpg)

-   **Second Graph (Gender)**: This graph depicts two main clusters representing gender categories (male and female), with individuals linked to their corresponding gender.

    ![](images/sim2-01.jpg)

-   **Third Graph (Race)**: The graph visualizes clusters of individuals grouped by race, showing the distribution and connections within racial categories such as White, Black, or Others.
